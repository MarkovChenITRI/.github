...
5. 在 manifest 中同時保存 CEO 原始明確要求與 PM 派生規劃；Page Inventory、分項索引與施工藍圖不得取代 CEO 原始 IA 或最低成功標準。
6. 若需要重新命名、合併頁面、壓縮層級或改變 CEO 明確 IA，必須列為 PM proposed mapping 並取得 CEO signoff；未同意前狀態維持 blocked。
...
3. 要求 RD / QE / 當前文件 owner 使用統一指標輸出契約。