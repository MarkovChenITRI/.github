...
| Copilot 操作驗證 | `instructions/test-operations.instructions.md`（撰寫）、`prompts/test-operations.prompt.md`（執行） | 執行步驟 | 寫入測試紀錄 | `tests/operations/<flow>.md` |
