...
內容是市場、預算、時程這類商業提案，屬於計劃書；內容是整個專案的技術總覽、單一模組的介面與行為細節、或單一使用者操作流程的驗收條件，都屬於規格書。這個 skill 底下所有對應文件，都要先遵照 `.github/instructions/plan.instructions.md` 的技能通用準則，再依下表對應的方式執行：
...
| 段落 | 對應文件 | 協作方式 | 職責名稱 | 產出路徑 |
| --- | --- | --- | --- | --- |
| 系統架構 | `.github/prompts/plan-architecture.prompt.md` | 問答步驟 | 系統架構設計 | `<專案資料夾>/.github/specs/architecture.md` |
| 模組規格 | `.github/prompts/plan-module-spec.prompt.md` | 問答步驟 | 模組規格設計 | `<專案資料夾>/.github/specs/modules.md` |
| 使用範例／驗收標準 | `.github/prompts/plan-examples.prompt.md` | 問答步驟 | 使用流程驗收設計 | `<專案資料夾>/.github/specs/examples.md` |
