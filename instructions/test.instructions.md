...
| 測試類型 | 路徑 | 詳細規則 |
|---|---|---|
| units（領域層單元測試） | `tests/units/` | `test-ci.instructions.md` |
| modules（應用層整合測試） | `tests/modules/` | `test-ci.instructions.md` |
| infra（硬體依賴，僅本機） | `tests/infra/` | `test-infra.instructions.md` |
